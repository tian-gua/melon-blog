...
class H2Renderer extends BaseRenderer implements Renderer {
    async render(block: Block) {
        ...
        return <div className="w-full flex justify-center items-center"><h2 key={block.id} id={block.id} className={"sketchy text-[1.2em] font-bold mt-6 mb-4"} style={style}>{text}</h2></div>
    }
}
